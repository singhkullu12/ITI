...
$otp1 = $this->db->query("SELECT * FROM one_time_fee WHERE student_id='$studID' ORDER BY id DESC LIMIT 1");
                    ...
                    <div class="panel-heading panel-red">Student Detail</div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row space15">
                                    <div class="col-sm-12 center">
                                        <?php if(strlen($pk->stud_image > 0)):?>
                                            <img alt="<?php echo $pk->name;?>" height="148" width="138" src="<?php echo base_url()?>assets/images/stuImage/<?php echo $pk->stud_image;?>" />
                                        <?php else:?>
                                ...
                                <div class="row space15">
                                    <div class="col-sm-12">	
                                        <div class="col-sm-4">Trade,Shift &amp; Unit.</div>
                                        <div class="col-sm-8">
                                            ...
                                            <?php
                                                foreach($fields1 as $field):
                                                    ...
                                                    ?>
                                                        <div class="row space15">
                                                            <div class="col-sm-12">
                                                                <div class="col-sm-6"> <?php if($field == "Admission_Fee") {echo "Paid_Admission_Fee";}else{echo $field; }?></div>
                                                                <div class="col-sm-6">
                                                                    <input type="text" id="<?php echo $field; ?>"  <?php if($otp1->num_rows()>0){ $otp=$otp1->row(); if(($field=="Admission_Fee" )|| ($field=="Others_Charges" )){ }else{?>value = "<?php echo $otp->$field;?>"<?php } }?> name="<?php echo $field; ?>" <?php if($field =="ANNUAL/Admission_Fee"){?> required="required" <?php  } if($month>0){ if($field == "Total_Admission_Fee" || $field == "Remaining_Admission_fee"  || $field == "Remaining_Admission_fee" || $field == "Last_Paid" ){  ?> disabled="disabled"<?php }}?> class="form-control"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input type="text" id="<?php if($field == "Games_&_Sports_Fee"){echo "game";
                                                                 ...
                                                                 if(($field == "Examination_Fee")&&($month == 5))
                                                                	...
                                                                	<?php if($field == "Others_Fee"){echo 'disabled="disabled" required = "required"';} ?> class="form-control"/>
...
<!-- ------------------------------------------------- Payment mode and Fee Detail Column End ------------------------------------------------------ -->		
	...
	<?php endforeach; 
	foreach($fields1 as $field):
		if($field != "id" && $field != "student_id" && $field != "diposit_date" && $field != "Total_Admission_Fee"  && $field != "Remaining_Admission_fee" && $field != "Last_Paid"):?>
			...
			$("#<?php if($field == "Games_&_Sports_Fee"){echo "game";}else{echo $field;} ?>").keyup(function(){
				...
				<?php if($month == 0):?>
					<?php foreach($fields1 as $field): ?>
						<?php if($field != "id" && $field != "student_id" && $field != "diposit_date" && $field != "Total_Admission_Fee"  && $field != "Remaining_Admission_fee" && $field != "Last_Paid"):?>
							count += Number($("#<?php echo $field; ?>").val());
						<?php endif; ?>
					<?php endforeach; ?>
				<?php endif?>
